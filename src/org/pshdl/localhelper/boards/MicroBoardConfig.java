...
public class MicroBoardConfig {
	...
	public static BoardSpecSettings createMicroBoard() {
		...
		final BoardSpecSettings microBoard = new BoardSpecSettings(
				...
				fpga, clkRst, dips, leds, uart, i2c, pmod1, pmod2);
		return microBoard;
	}
	...
	private static PinSpecGroup createPMod2() {
		...
		final PinSpec p1 = new PinSpec("PMOD2_P1", "H12", "Pin 1 of PMOD interface", defAttribute, null, null);
		final PinSpec p2 = new PinSpec("PMOD2_P2", "G13", "Pin 2 of PMOD interface", defAttribute, null, null);
		final PinSpec p3 = new PinSpec("PMOD2_P3", "E16", "Pin 3 of PMOD interface", defAttribute, null, null);
		final PinSpec p4 = new PinSpec("PMOD2_P4", "E18", "Pin 4 of PMOD interface", defAttribute, null, null);
		final PinSpec p7 = new PinSpec("PMOD2_P7", "K12", "Pin 7 of PMOD interface", defAttribute, null, null);
		final PinSpec p8 = new PinSpec("PMOD2_P8", "K13", "Pin 8 of PMOD interface", defAttribute, null, null);
		final PinSpec p9 = new PinSpec("PMOD2_P9", "F17", "Pin 9 of PMOD interface", defAttribute, null, null);
		final PinSpec p10 = new PinSpec("PMOD2_P10", "F18", "Pin 10 of PMOD interface", defAttribute, null, null);
	...
	private static PinSpecGroup createPMod1() {
		final Map<String, String> defAttribute = Maps.newHashMap();
		defAttribute.put(PinSpec.IOSTANDARD, "LVCMOS33");
		final PinSpec p1 = new PinSpec("PMOD1_P1", "F15", "Pin 1 of PMOD interface", defAttribute, null, null);
		final PinSpec p2 = new PinSpec("PMOD1_P2", "F16", "Pin 2 of PMOD interface", defAttribute, null, null);
		final PinSpec p3 = new PinSpec("PMOD1_P3", "C17", "Pin 3 of PMOD interface", defAttribute, null, null);
		final PinSpec p4 = new PinSpec("PMOD1_P4", "C18", "Pin 4 of PMOD interface", defAttribute, null, null);
		final PinSpec p7 = new PinSpec("PMOD1_P7", "F14", "Pin 7 of PMOD interface", defAttribute, null, null);
		final PinSpec p8 = new PinSpec("PMOD1_P8", "G14", "Pin 8 of PMOD interface", defAttribute, null, null);
		final PinSpec p9 = new PinSpec("PMOD1_P9", "D17", "Pin 9 of PMOD interface", defAttribute, null, null);
		final PinSpec p10 = new PinSpec("PMOD1_P10", "D18", "Pin 10 of PMOD interface", defAttribute, null, null);
	...
	private static PinSpecGroup createI2C() {
		...
		final PinSpec scl = new PinSpec("scl", "P12", "SCL for I2C", defAttribute, null, Polarity.active_low);
		final PinSpec sda = new PinSpec("sda", "U13", "SDA for I2C", defAttribute, null, Polarity.active_low);
	...
	private static PinSpecGroup createUART() {
		final Map<String, String> defAttribute = Maps.newHashMap();
		defAttribute.put(PinSpec.IOSTANDARD, "LVCMOS33");
		final PinSpec rxd = new PinSpec("usb_rs232_rxd", "R7", "RXD, the receiver input on the FPGA, the serial output of the chip", defAttribute, null, null);
		final PinSpec txd = new PinSpec("usb_rs232_txd", "T7", "TXD, the sender output on the FPGA, the serial input of the chip", defAttribute, null, null);
	...
	private static PinSpecGroup createGPIODip() {
		...
		final PinSpec dip0 = new PinSpec("gpio_dip[0]", "B3", "GPIO Dip switch 0", defAttribute, null, Polarity.active_high);
		final PinSpec dip1 = new PinSpec("gpio_dip[1]", "A3", "GPIO Dip switch 1", defAttribute, null, Polarity.active_high);
		final PinSpec dip2 = new PinSpec("gpio_dip[2]", "B4", "GPIO Dip switch 2", defAttribute, null, Polarity.active_high);
		final PinSpec dip3 = new PinSpec("gpio_dip[3]", "A4", "GPIO Dip switch 3", defAttribute, null, Polarity.active_high);
	...
	private static PinSpecGroup createGPIOLED() {
		...
		final PinSpec led0 = new PinSpec("gpio_led[0]", "P4", "GPIO LED 0", defAttribute, null, Polarity.active_low);
		final PinSpec led1 = new PinSpec("gpio_led[1]", "L6", "GPIO LED 1", defAttribute, null, Polarity.active_low);
		final PinSpec led2 = new PinSpec("gpio_led[2]", "F5", "GPIO LED 2", defAttribute, null, Polarity.active_low);
		final PinSpec led3 = new PinSpec("gpio_led[3]", "C2", "GPIO LED 3", defAttribute, null, Polarity.active_low);
	...
	private static PinSpecGroup createResetClckGroup() {
		...
		final PinSpec clk_2 = new PinSpec("clock_y2", "K15", "66.667 MHz", defAttributes, new TimeSpec("66666.7", "KHz"), null);
		final PinSpec clk_3 = new PinSpec("clock_y3", "C10", "100 MHz", defAttributes, new TimeSpec("100000", "KHz"), null);
		final PinSpec backup_clock = new PinSpec("backup_clock", "R8",
				"The following oscillator is not populated in production but the footprint is compatible with the Maxim DS1088LU", defAttributes, null, null);
